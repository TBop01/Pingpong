...
const winnerAudio = new Audio('https://www.td-dko.com/content/authoringtooldb/1389/7084F4BC-9E04-3DD1-DFD1-9C3EB54DB4C0.mp3');
const playerOneAudio = new Audio('https://www.td-dko.com/content/authoringtooldb/1389/CD7C9B4F-B95D-3E45-B8C9-C2BFC50776B0.mp3');
const playerTwoAudio = new Audio('https://www.td-dko.com/content/authoringtooldb/1389/CD7C9B50-BDD7-A08F-AEC5-52DAF80C4737.mp3');
...
const view = new ScoreboardView(root, "Player One", "Player Two", (player, direction) => {
    ...
    if (playerOneScore >= 5 || playerTwoScore >= 5) {
        ...
        displayWinnerMessage(playerOneScore >= 5 ? 'Player 1 Wins. Great Success!!' : 'Player 2 Wins. Great Success!!');
...
document.querySelector('.player-one').addEventListener('click', generateRandomSentenceForPlayerOne);
document.querySelector('.player-two').addEventListener('click', generateRandomSentenceForPlayerTwo);
